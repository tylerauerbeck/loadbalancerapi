...
func (lb *LoadBalancerQuery) collectField(ctx context.Context, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "deleteTime":
			if _, ok := fieldSeen[loadbalancer.FieldDeleteTime]; !ok {
				selectedFields = append(selectedFields, loadbalancer.FieldDeleteTime)
				fieldSeen[loadbalancer.FieldDeleteTime] = struct{}{}
			}
		case "name":
